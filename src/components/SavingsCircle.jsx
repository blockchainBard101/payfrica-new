...
const savingsCircles = [
    { title: "WCA Contribution", amount: "₦3000", progress: 30, color: "#FF4D4D" },
    { title: "December Doings", amount: "₦45,000", progress: 70, color: "#007BFF" },
    { title: "Church Project", amount: "₦80,000", progress: 50, color: "#00CFFF" },
    { title: "New PC Geng", amount: "₦10,000", progress: 20, color: "#8B0000" },
    { title: "Bro Matt Wedding", amount: "₦30,000", progress: 45, color: "#FF4D4D" },
