...
//                         <FaCalendarAlt style={{ color: '#999', marginRight: '8px' }} />
//                         <input
//                             type="text"
//                             placeholder="01 Jan - 03 Mar"
//                             style={{
//                                 border: 'none',
//                                 outline: 'none',
//                                 fontSize: '14px',
...
//             {/* Table */}
//             {filtered.length > 0 ? (
//                 <div style={{ overflowX: 'auto' }} className='transaction-table-wrapper'>
//                     <table style={{ width: '100%', borderCollapse: 'collapse' }} className='transaction-table'>
// <thead>
//     <tr>
//         {['Tx ID', 'Counterparty', 'Type', 'Date', 'Amount', 'Fee', 'Status', 'Action'].map((h, i) => (
//             <th
...
//                                 return (
//                                     <tr key={txn.id}>
//                                         <td style={baseCell}>{txn.transactionId}</td>
//                                         <td style={baseCell}>{txn.interactedWith}</td>
//                                         <td style={baseCell}>{txn.type}</td>
//                                         <td style={baseCell}>{formatDate(txn.date)}</td>
//                                         <td style={baseCell}>
//                                             {isConvert ? (
//                                                 <div style={{ display: 'flex', flexDirection: 'column' }}>
//                                                     <span style={{ marginBottom: '4px', color: '#b91c1c' }}>
...
//                                             <button style={statusStyle}>{txn.status}</button>
//                                         </td>
//                                         <td style={{ ...baseCell, textAlign: 'center', cursor: 'pointer' }}>
//                                             <FaEllipsisV />
//                                         </td>
//                                     </tr>
//                                 )
...
//                         Ready for your first transaction? Your history will appear here once you begin to use Payfrica.
//                     </p>
//                     <button style={{
